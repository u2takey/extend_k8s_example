...
import (
	...
	. "github.com/u2takey/extend_k8s_example/pkg/apis/simple/v1alpha1"
	. "github.com/u2takey/extend_k8s_example/pkg/client/clientset_generated/clientset/typed/simple/v1alpha1"
...
var _ = Describe("NginxApp controller", func() {
	var instance NginxApp
	var expectedKey string
	var client NginxAppInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "nginxapp-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.SimpleV1alpha1().NginxApps("nginxapp-controller-test-handler")
