...
import (
	...
	scheme "github.com/u2takey/extend_k8s_example/pkg/client/clientset_generated/internalclientset/scheme"
...
type NginxAppInterface interface {
	Create(*simple.NginxApp) (*simple.NginxApp, error)
	Update(*simple.NginxApp) (*simple.NginxApp, error)
	UpdateStatus(*simple.NginxApp) (*simple.NginxApp, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*simple.NginxApp, error)
	List(opts v1.ListOptions) (*simple.NginxAppList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *simple.NginxApp, err error)
	NginxAppExpansion
}
...
func newNginxApps(c *SimpleClient, namespace string) *nginxApps {
	return &nginxApps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nginxApps) Get(name string, options v1.GetOptions) (result *simple.NginxApp, err error) {
	result = &simple.NginxApp{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nginxapps").
		Name(name).
...
func (c *nginxApps) List(opts v1.ListOptions) (result *simple.NginxAppList, err error) {
	result = &simple.NginxAppList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nginxapps").
...
func (c *nginxApps) Create(nginxApp *simple.NginxApp) (result *simple.NginxApp, err error) {
	result = &simple.NginxApp{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nginxapps").
...
func (c *nginxApps) Update(nginxApp *simple.NginxApp) (result *simple.NginxApp, err error) {
	result = &simple.NginxApp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nginxapps").
...
func (c *nginxApps) UpdateStatus(nginxApp *simple.NginxApp) (result *simple.NginxApp, err error) {
	result = &simple.NginxApp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nginxapps").
...
func (c *nginxApps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *simple.NginxApp, err error) {
	result = &simple.NginxApp{}
